...
INSERT INTO Fornecedores (ID, Nome, Endereco, Cidade, Telefone)
VALUES
...
VALUES
    ...
    (51, 'Detergente', 'Detergente de limão', 1.29, 150, 7, 9),
    (52, 'Sabão em Pó', 'Sabão em pó para roupas', 5.99, 80, 7, 8),
    (53, 'Desinfetante', 'Desinfetante de lavanda', 2.49, 100, 7, 10),
    (54, 'Esponjas', 'Pacote de esponjas', 1.99, 120, 7, 7),
    (55, 'Papel Toalha', 'Rolo de papel toalha', 2.79, 70, 7, 2),
    (56, 'Limpador Multiuso', 'Limpador multiuso', 3.49, 60, 7, 4),
    (57, 'Amaciante de Roupa', 'Amaciante floral', 4.99, 50, 7, 5),
    (58, 'Sacos de Lixo', 'Pacote de sacos de lixo', 3.29, 80, 7, 3),
    (59, 'Alvejante', 'Alvejante sem cloro', 2.59, 70, 7, 1),
    (60, 'Mop', 'Mop de limpeza', 9.99, 40, 7, 6),

    -- Produtos de Higiene (Categoria 8)
    (61, 'Sabonete', 'Sabonete em barra', 0.99, 300, 8, 6),
    (62, 'Shampoo', 'Shampoo hidratante', 4.49, 150, 8, 2),
    (63, 'Escova de Dentes', 'Escova de dentes macia', 2.49, 200, 8, 4),
    (64, 'Creme Dental', 'Creme dental branqueador', 2.99, 180, 8, 7),
    (65, 'Papel Higiênico', 'Rolo de papel higiênico', 1.79, 220, 8, 5),
    (66, 'Lenços Umedecidos', 'Lenços umedecidos', 3.99, 120, 8, 1),
    (67, 'Fio Dental', 'Fio dental com sabor', 1.29, 160, 8, 3),
    (68, 'Desodorante', 'Desodorante roll-on', 2.99, 140, 8, 10),
    (69, 'Sabonete Líquido', 'Sabonete líquido de lavanda', 3.49, 110, 8, 8),
    (70, 'Absorvente Feminino', 'Absorvente com abas', 4.99, 100, 8, 9),

    -- Produtos de Hortifruti (Categoria 9)
    (71, 'Maçãs', 'Maçãs vermelhas frescas', 0.79, 80, 9, 3),
    (72, 'Bananas', 'Bananas maduras', 0.59, 100, 9, 9),
    (73, 'Cenouras', 'Cenouras orgânicas', 1.29, 70, 9, 7),
    (74, 'Alface', 'Alface americana', 1.99, 60, 9, 4),
    (75, 'Tomates', 'Tomates orgânicos', 2.49, 50, 9, 5),
    (76, 'Brócolis', 'Brócolis frescos', 1.79, 40, 9, 6),
    (77, 'Morangos', 'Morangos frescos', 2.99, 30, 9, 1),
    (78, 'Laranjas', 'Laranjas suculentas', 1.49, 70, 9, 8),
    (79, 'Uvas', 'Uvas sem sementes', 3.99, 40, 9, 2),
    (80, 'Abacaxi', 'Abacaxi maduro', 2.99, 30, 9, 10);
